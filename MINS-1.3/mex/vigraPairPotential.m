function [labels] = vigraPairPotential(in, opts)
% function [labels] = vigraPairPotential(in, opts)
%  
% [labels] = vigraPairPotential(in, opts) models the input node/edge potentials as a graph and calls the max-flow/mini-cut algorithm to partition it into foreground and background.
% 
...
% [labels] = vigraPairPotential(in, opts);
% 
