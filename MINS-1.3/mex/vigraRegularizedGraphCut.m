function [labels] = vigraRegularizedGraphCut(in, opts)
% function [labels] = vigraRegularizedGraphCut(in, opts)
%  
% [labels] = vigraRegularizedGraphCut(in, opts) models the input node/edge potentials as a graph and calls the max-flow/mini-cut algorithm to partition it into foreground and background.
% 
...
% [labels] = vigraRegularizedGraphCut(in, opts);
% 
