function ButtonName=questdlg2(Pos,Question,Title,Btn1,Btn2,Btn3,Default)
% MFQUESTDLG Question dialog box.
% ----------------------------------------------------------------------- 
%  --------------------- Modified Function Help ----------------------
%  ‘questdlg2’ is a simple modification of ‘questdlg’ which enables user
...
%  The position vector must be added as the first element of ‘questdlg2’.
%  Example:
%  button = questdlg2 ( [ 0.6 , 0.1 ] , 'Is the position proper?' , 'Is it OK?' ); 
% -------------------------------------------------------------------------
