function data = readlsm(fname)
% function data = readlsm(fname) reads data from lsm file

data = tiffread(fname);

nZstacks = length(data);
nChannels = length(data(1).data);

tmp = cell(nZstacks, nChannels);
