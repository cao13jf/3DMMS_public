...
% load ground truth
GT = load_nii('C:\Users\bcc\Desktop\BMCevaluation\PartialGroundTruth\GroundTruth\ZHAO1\MatlabProcessed\membt044sr.nii');
GT = GT.img;
DMMS = load_nii('C:\Users\bcc\Desktop\BMCevaluation\BCOMS\results\NiiFile\membt044s.nii');
DMMS = DMMS.img;
labels = unique(GT(:));
labels(labels == 0)= [];
...
save_file = 'C:\Users\bcc\Desktop\BMCevaluation\AllResults\BCOMS\membt044s.nii';
