function repairedMemb = repairTopSurfaceOfMemb(membStack, filteredMemb)
...
intensityFilteredMask1 = distEmbryoAndMemb1 > intensityThreshold ;   %distEmbryoAndMemb1 < SZ/3;
    %filter noisy region
areaFilteredMask1 = bwareafilt(intensityFilteredMask1, [sizeThreshold, 10000]);
...
intensityFilteredMask2 = distEmbryoAndMemb2 > intensityThreshold * 0.6; %distEmbryoAndMemb2 <SZ/3;
    %filter noisy region
areaFilteredMask2 = bwareafilt(intensityFilteredMask2, [sizeThreshold, 10000]);
