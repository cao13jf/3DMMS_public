...
parfor timePoint = 1:max_Time
    ...
    filteredMem = repairTopSurfaceOfMemb(membStack0, filteredMem0);
...
mergeTimeTree = seriesStepAnalyze(seriesDivTree);
save_file = fullfile('.\results\resultWithMerge\mergedResults', data_name, 'mergeTimeTree.mat');
save(save_file, 'mergeTimeTree');

%% merge pairs of son cells according to the saved results in the last step
